                    ...
                    <form action="<?= base_url('item/add') ?>" method="post">
                        <div class="form-example-int">
                            <div class="form-group">
                                <label>Nom</label>
                                <div class="nk-int-st">
                                    <input type="text" class="form-control input-sm" placeholder="Veuillez saisir le nom de la video" name="name">
                                </div>
                            </div>
                        </div>
                        <div class="form-example-int">
                            <div class="form-group">
                                ...
                                <div class="nk-int-st">
                                    <input type="text" class="form-control input-sm" placeholder="Veuillez saisir le lien de la video" name="url">
                                </div>
                            </div>
                        </div>
                        <div class="form-example-int">
                            ...
                            <div class="form-group">
                                ...
                                <!-- <div class="nk-int-st"> -->
                                <textarea id="form7" class="md-textarea form-control" rows="3" name="description" placeholder="Veuillez saisir la description de la video"></textarea>
                                <!-- </div> -->
                            </div>
                            </div>
